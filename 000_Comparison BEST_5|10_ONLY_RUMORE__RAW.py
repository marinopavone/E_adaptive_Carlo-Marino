...
# Load models with custom object registration
Nrm_model_pca = load_model("Tensorflow_models/CDC_autoencoders/BEST5_Nrm_model_(2000, 16800, 0.1).keras",
                       custom_objects={'AutoEncoder': AutoEncoder})
CTR_model_pca = load_model("Tensorflow_models/CDC_autoencoders/BEST5_CTR_model_(2000, 16800, 0.01, 0.01).keras",
                       custom_objects={'AutoEncoder': AutoEncoder})
Spa_model_pca = load_model("Tensorflow_models/CDC_autoencoders/BEST5_Spa_model_(2000, 16800, 0.01, 0.3, 0.3).keras",
                       custom_objects={'AutoEncoder': AutoEncoder})
std_noise_test = [0, 0.0005, 0.002, 0.03, 0.1, 0.4, 0.8, 10]
