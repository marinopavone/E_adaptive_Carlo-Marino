...
num_epochs_list = [20000]  # Different epoch values
batch_size_list = [ 15000]
...
for num_epochs, batch_size, learning_rate, momentum in product(num_epochs_list, batch_size_list, learning_rate_list, momentum):
    model, _ = CLS_neural_network_training(x_train_enc, y_train, num_epochs=num_epochs,
                                            ...
                                            num_classes=y_train.shape[1], hidden_units=15)
...
best_model.save("Tensorflow_models/CDC_CLS_only/BEST_2l_Nrm_CLS_only" + str(best_params) + ".keras")
