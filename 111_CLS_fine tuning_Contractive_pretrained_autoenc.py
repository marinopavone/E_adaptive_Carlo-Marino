...
x_train_enc = CTR_autoencoder.bottleneck(x_train)
x_test_enc = CTR_autoencoder.bottleneck(x_test)
#%%   tuning
...
best_model.save("Tensorflow_models/CDC_CLS_only/BEST_CTR_CLS_only" + str(best_params) + ".keras")
