...
# Load models with custom object registration
Nrm_model_pca = load_model("Tensorflow_models/CDC_autoencoders/BEST_Nrm_model_(2000, 16800, 0.1).keras",
                       custom_objects={'AutoEncoder': AutoEncoder})
CTR_model_pca = load_model("Tensorflow_models/CDC_autoencoders/BEST_CTR_model_(2000, 16800, 0.01, 0.01).keras",
                       custom_objects={'AutoEncoder': AutoEncoder})
Spa_model_pca = load_model("Tensorflow_models/CDC_autoencoders/BEST_Spa_model_(2000, 16800, 0.01, 0.05, 0.05).keras",
                       custom_objects={'AutoEncoder': AutoEncoder})
std_noise_test = [0, 0.0005, 0.002, 0.03, 0.1, 0.4, 0.8, 10]
